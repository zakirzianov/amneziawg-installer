...
- **+84 new bats** (230 total, up from 146 on v5.10.2).
  ...
  - `test_restore_rollback.bats` (+27) — `_restore_do_rollback` helper, `trap RETURN` + cleanup contract, `_destructive_ops_started` gate, pre-flight `validate_awg_config`, post-audit Q1/Q2/Q3 regressions.
